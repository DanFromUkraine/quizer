...
export function getNewBookWithDeletedCardId(
    ...
    const newCardIdsOrder = getListWhereNoSuchIds(cardIdsOrder, [idToDelete]);
...
export function getBookWithNewId({
    ...
    return cardType === 'explicit'
        ? {
              ...other,
              cardIdsOrder: newCardIdsOrder,
              explicitCardIds: getListWithSuchIds(other.explicitCardIds, [
                  cardId
              ])
          }
        : {
              ...other,
              cardIdsOrder: newCardIdsOrder,
              shortCardIds: getListWithSuchIds(other.shortCardIds, [cardId])
          };
}
