...
export const NEW_STORY_PARAMS: NewStoryParam[] = [
    {
        ...
        maxNumAtom:
            getNewStoryMaxNumOfExplicitCardsAdapterAtom as ReadOnlyAdapterAtom,
    ...
    },
    {
        ...
        maxNumAtom:
            getNewStoryMaxNumOfNormalCardsAdapterAtom as ReadOnlyAdapterAtom,
    ...
    },
    {
        ...
        maxNumAtom:
            getNewStoryMaxNumOfTypeInCardsAdapterAtom as ReadOnlyAdapterAtom,
    ...
    },
    {
        ...
        maxNumAtom:
            getNewStoryMaxNumOfIsCorrectCardsAdapterAtom as ReadOnlyAdapterAtom,
